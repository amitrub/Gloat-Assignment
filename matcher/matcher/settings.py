...
SECRET_KEY = 'django-insecure-p-y%x(b&6o@=rr_fj+$13&d(y)&ef&2xtieblof^3+q2zo$2yr'
...
DATABASES1 = {
    'default': {
        ...
        'NAME': os.environ.get('MYSQL_DATABASE', 'matcher_db'),
...
DATABASES = DATABASES1 if os.environ.get('USE_MYSQL') else DATABASES2
